...
<header class="header<? if (Yii::$app->request->url !== Yii::$app->homeUrl) {?> header_pages<?}?>" data-slideout-ignore>
    ...
    <div class = "head_cont cont">
        ...
        <div class="phone_soc">
            ...
            <div class="btn-hamburger js-slideout-toggle bars">
                <a><img src="/public/img/menu.svg" alt="Меню"></a>
            </div>
        </div>
    </div>
    ...
    <? if (Yii::$app->request->url === Yii::$app->homeUrl) {?>
        ...
        <div class="head_ok cont">
            <div class="head_ok_1">
                <img src="/public/img/ok.png" alt="ok">
                <p><?= array_key_exists('item_1', Yii::$app->params['HomePage'])?Yii::$app->params['HomePage']['item_1']:'' ?></p>
            </div>
            <div class="head_ok_1">
                <img src="/public/img/ok.png" alt="ok">
                <p><?= array_key_exists('item_2', Yii::$app->params['HomePage'])?Yii::$app->params['HomePage']['item_2']:'' ?></p>
            </div>
            <div class="head_ok_1">
                <img src="/public/img/ok.png" alt="ok">
                <p><?= array_key_exists('item_3', Yii::$app->params['HomePage'])?Yii::$app->params['HomePage']['item_3']:'' ?></p>
            </div>
        </div>
