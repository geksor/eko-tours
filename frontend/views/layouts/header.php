<header class="header" data-slideout-ignore>
    <div class="black">
    ...
    <div class = "head_cont cont">
        ...
        <div class="phone_soc">
            <div class="soc">
                <a href = "https://vk.com/ecotoursadigea" target="_blank">
                ...
                <a href = "https://www.instagram.com/eko_tours_adigea/" target="_blank">
    ...
    <div class="head_name cont">
        <h1>Активный отдых<br>в горах Адыгеи</h1>
        <a href="/tours.php" class="head_but">Выбрать тур</a>
    </div>
    <div class="head_ok cont">
        <div class="head_ok_1">
            <img src="/public/img/ok.png" alt="ok">
            <p>Работаем официально.<br>В Едином реестре туроператоров наш номер<br>РТО 019362.</p>
        </div>
        <div class="head_ok_1">
            <img src="/public/img/ok.png" alt="ok">
            <p>Туристская деятельность застрахована<br>в ПАО Росгосстрах №01/35/162/00830.</p>
        </div>
        <div class="head_ok_1">
            <img src="/public/img/ok.png" alt="ok">
            <p>Собственный гостевой дом «Рябиновые бусы»<br>ryabinovka.com, рейтинг гостевого дома на<br>www.booking.com - 9,2 из 10 и более 200 отзывов.</p>
        </div>
    </div>
</header><!-- .header-->
