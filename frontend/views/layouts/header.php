...
<header class="header<? if (Yii::$app->request->url !== Yii::$app->homeUrl) {?> header_pages<?}?>" data-slideout-ignore>
    ...
    <div class = "head_cont cont">
        ...
        <div class="phone_soc">
            ...
            <div class="phone">
                <a href="tel:<?= Yii::$app->params['Contact']['phone'] ?>" style="text-decoration: none"><?= Yii::$app->params['Contact']['phone'] ?></a>
            </div>
    ...
    <? if (Yii::$app->request->url === Yii::$app->homeUrl) {?>
        ...
        <div class="head_name cont">
            <h1><?= Yii::$app->params['HomePage']['headerTitle'] ?></h1>
            <a href="/tours" class="head_but">Выбрать тур</a>
        </div>
        <div class="head_ok cont">
            <div class="head_ok_1">
                <img src="/public/img/ok.png" alt="ok">
                <p><?= Yii::$app->params['HomePage']['item_1'] ?></p>
            </div>
            <div class="head_ok_1">
                <img src="/public/img/ok.png" alt="ok">
                <p><?= Yii::$app->params['HomePage']['item_2'] ?></p>
            </div>
            <div class="head_ok_1">
                <img src="/public/img/ok.png" alt="ok">
                <p><?= Yii::$app->params['HomePage']['item_3'] ?></p>
            </div>
        </div>
