...
/**
 * AccomController implements the CRUD actions for Accom model.
 */
class AccomController extends Controller
{
    ...
    /**
     * Lists all Accom models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new AccomSearch();
    ...
    /**
     * Updates an existing Accom model.
    ...
    /**
     * Deletes an existing Accom model.
    ...
    /**
     * Finds the Accom model based on its primary key value.
